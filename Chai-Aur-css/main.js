...
const styleHandlers = {
  ...
  chaiP: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.padding = `${classSubArray[1]}${classSubArray[2]}`;//chaiP-10-rem
    } else {
  ...
  chaiPx: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingLeft = `${classSubArray[1]}${classSubArray[2]}`;//chaiPx-10-rem
      el.style.paddingRight = `${classSubArray[1]}${classSubArray[2]}`;//chaiPx-10-rem
    } else {
  ...
  chaiPy: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingTop = `${classSubArray[1]}${classSubArray[2]}`;//chaiPy-10-rem
      el.style.paddingBottom = `${classSubArray[1]}${classSubArray[2]}`;//chaiPy-10-rem
    } else {
  ...
  chaiPl: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingLeft = `${classSubArray[1]}${classSubArray[2]}`;//chaiPl-10-rem
    } else {
  ...
  chaiPr: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingRight = `${classSubArray[1]}${classSubArray[2]}`;//chaiPr-10-rem
    } else {
  ...
  chaiPt: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingTop = `${classSubArray[1]}${classSubArray[2]}`;//chaiPt-10-rem
    } else {
  ...
  chaiPb: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.paddingBottom = `${classSubArray[1]}${classSubArray[2]}`;//chaiPb-10-rem
    } else {
  ...
  chaiM: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.margin = `${classSubArray[1]}${classSubArray[2]}`;//chaiM-10-rem
    } else {
  ...
  chaiMx: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginLeft = `${classSubArray[1]}${classSubArray[2]}`;//chaiMx-10-rem
      el.style.marginRight = `${classSubArray[1]}${classSubArray[2]}`;//chaiMx-10-rem
    } else {
  ...
  chaiMy: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginTop = `${classSubArray[1]}${classSubArray[2]}`;//chaiMy-10-rem
      el.style.marginBottom = `${classSubArray[1]}${classSubArray[2]}`;//chaiMy-10-rem
    } else {
  ...
  chaiMl: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginLeft = `${classSubArray[1]}${classSubArray[2]}`;//chaiMl-10-rem
    } else {
  ...
  chaiMr: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginRight = `${classSubArray[1]}${classSubArray[2]}`;//chaiMr-10-rem
    } else {
  ...
  chaiMt: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginTop = `${classSubArray[1]}${classSubArray[2]}`;//chaiMt-10-rem
    } else {
  ...
  chaiMb: (el, classSubArray) => {
    ...
    if (classSubArray.length === 3) {
      el.style.marginBottom = `${classSubArray[1]}${classSubArray[2]}`;//chaiMb-10-rem
    } else {
  ...
  chaiB: (el, classSubArray) => {
    if (classSubArray.length > 2) {
      if (color.hasOwnProperty(classSubArray[1])) {
        el.style.border = `${classSubArray[2]}px solid ${color[classSubArray[1]]
          }`;//chaiB-gray-10
      }
